"""MHEALTH Mobile Health Human Activity Recognition -- 12 activity classes.

Backward-compatible re-export layer. The original monolithic module was
split into focused sub-modules:

    constants  -- activity class names, NUM_CLASSES, NUM_CHANNELS
...
from fl_blockchain_evm.core.constants import (  # noqa: F401
    ACTIVITY_NAMES, SC_NAMES, NUM_CLASSES, NUM_CHANNELS,
)
